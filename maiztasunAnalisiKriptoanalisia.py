...
# EGILEA: Leire Garcia
# Programaren helburua maiztasun analisiaz baliatuz mezu baten kriptoanalisia egitea da.
# Horretarako programak testuaren hizkien maiztasun analisisa egiten du, eta gehien erabiltzen 
# diren hizkiak automatikoki aldatzen ditu gaztelaniaz gehien errepikatzen diren hizkiegaz.
# Gero erabiltzaileak hizkiak aldatzen joan beharko da, testua deszifratu arte.
...
# Testua programan sartu
    ...
    print(hizkiak)
    print('\n')
    print('Gure testuan gehien errepikatzen diren hiru karaktereak hauek dira:') # Gure testuak hutsuneak dituenez, hauek izango dira gehien errepikatzen diren karaktereak, beraz, gure programak ez ditu kontuan artuko eta gehien errepikatu diren hurrengo bi karaktereak erabiliko ditu ordezkapenak egiten hasteko.
...
#OHARRA
#Textu hau lortzeko hauek dira egin beharrreko aldaketak:
#('X', 'e'), ('E', 'a')
#('T', 'l'), ('J', 'n'), ('V', 'y'), ('A', 'd')
#CndeDendenRCa hitza agertzen da: ('C', 'i'), ('D', 'p'), ('R', 'c')
#diKecciIn suposatu dezakegu direccion jartzen duela: ('N', 's'), ('K', 'r'), ('I', 'o')
#revolZcion suposatu dezakegu revolucion jartzen duela: ('Z', 'u')
#anarSuisHa suposatu dezakegu anarquista jartzen duela: ('S', 'q'), ('H', 't')
#('O', 'f'), ('P', 'm'), ('G', 'j'), ('L', 'z'), ('Q', 'b'), ('F', 'x'), ('U', 'g'), ('M', 'h')
